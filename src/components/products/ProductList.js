...
export const ProductList = ({ searchTermState }) => {
  ...
  useEffect(
   ...
   const shouldShowProductList = kandyUserObject.staff || searchTermState;
      ...
      {shouldShowProductList && (
        <>
          ...
          {kandyUserObject.staff && (
            <>
              <button id="show-all-button" onClick={() => setShowTopPriced(false)}>
                Show All
              </button>
              <button id="top-priced-button" onClick={() => setShowTopPriced(true)}>
                Show Top Priced
              </button>
              <button id="create-product-button" onClick={() => navigate("/products/new")}>
                Create Product
              </button>
            </>
          )}
